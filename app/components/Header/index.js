    ...
    <div>
      <div style={{ background: '#2874f0', padding: '1%', color: '#FFF' }}>
        <div>
          ...
          <div className="form-group" style={{display: 'inline', marginLeft: '13%' }}>
            <button type="button" class="btn" style={{ width: '8%', background: '#FFF', fontWeight: '500', color: 'blue' }}>Login</button>
          </div>
